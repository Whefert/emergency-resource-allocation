class EmergencyTypePriorityResource:
    def __init__(self, emergency_type_id:int, priority_id:int, resource_type_id:int, recommended_quantity: int, emergency_type_priority_resource_id:int=None):
    ...
    # Getters and Setters
    def get_emergency_type_priority_resources_id(self):
    ...
    def __repr__(self):
        return f"EmergencyTypepriorityResource(emergency_type_priority_resources_id={self.emergency_type_priority_resource_id}, emergency_type_id={self.emergency_type_id}, priority_id={self.priority_id}, recommended_resource_type_id={self.recommended_resource_type_id}, recommended_quantity={self.recommended_quantity})"
